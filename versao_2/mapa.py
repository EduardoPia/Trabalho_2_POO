...
class Mapa:
    def __init__(self):
        ...
        self.grama = ler_imagem(ConfigJogo.IMG_GRAMA,ConfigJogo.ARENA_AREA.as_tuple())
        self.indestructable = ler_imagem(ConfigJogo.IMG_INDESTRUCTABLE,(ConfigJogo.TILE_SIZE.x+1,ConfigJogo.TILE_SIZE.y+1))
        self.destructable = ler_imagem(ConfigJogo.IMG_DESTRUCTABLE,(ConfigJogo.TILE_SIZE.x+1,ConfigJogo.TILE_SIZE.y+1))
